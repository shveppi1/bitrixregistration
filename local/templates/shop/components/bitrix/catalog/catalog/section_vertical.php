...
?>
		...
		<div class="row sort-block ">
			...
			<div class="cont-sort">
				<select name="price" class="sort-input <?= $_GET['price'] ? 'active' : ''?>" onchange="location = this.value;">
					<option disabled selected="selected" >Сортировка по цене</option>
					<option value="?price=asc" <?= $_GET['price'] == 'asc' ? 'selected="selected"' : ''?>>Цена ↑</option>
					<option value="?price=desc" <?= $_GET['price'] == 'desc' ? 'selected="selected"' : ''?>>Цена ↓</option>
				</select>



				<select name="popular" class="sort-input <?= $_GET['popular'] ? 'active' : ''?>" onchange="location = this.value;">
					<option disabled selected="selected" >Сортировка по популярности</option>
					<option value="?popular=asc" <?= $_GET['popular'] == 'asc' ? 'selected="selected"' : ''?>>По популярности ↑</option>
					<option value="?popular=desc" <?= $_GET['popular'] == 'desc' ? 'selected="selected"' : ''?>>По популярности ↓</option>
				</select>
			</div>
		...
		$arParams["ELEMENT_SORT_FIELD"] = $_GET['price'] ? 'catalog_PRICE_1' : $arParams["ELEMENT_SORT_FIELD"];
		$arParams["ELEMENT_SORT_ORDER"] = $_GET['price'] ? $_GET['price'] : $arParams["ELEMENT_SORT_ORDER"];

		$arParams["ELEMENT_SORT_FIELD"] = $_GET['popular'] ? 'PROPERTY_INT_BUY' : $arParams["ELEMENT_SORT_FIELD"];
		$arParams["ELEMENT_SORT_ORDER"] = $_GET['popular'] ? $_GET['popular'] : $arParams["ELEMENT_SORT_ORDER"];
